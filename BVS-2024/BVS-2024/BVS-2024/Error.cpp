...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(601, "MFST: Ошибка в параметрах функции"),
		ERROR_ENTRY(602, "MFST: Ошибка в возвращаемом значении функции"),
		ERROR_ENTRY(603, "MFST: Ошибка в выражении"),
		ERROR_ENTRY(604, "MFST: Ошибка в присвоении"),
		ERROR_ENTRY(605, "MFST: Ошибка в параметрах, передаваемых в display"),
		ERROR_ENTRY(606, "MFST: Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(607, "MFST: Ошибка в параметрах условной конструкции"),
		...
		ERROR_ENTRY(710, "SA: Конструкция if может принимать в качество проверки либо boolean, либо данные, которые совпадают по типу данных"),
		ERROR_ENTRY(711, "SA: Display не принимает в качестве параметра функцию типа 'процедура'"),
		ERROR_ENTRY(712, "SA: Целочисленный литерал может принимать значения от 0 до 4294967295"),
		ERROR_ENTRY(713, "SA: Функции стандартной библиотеки должны принимать два параметра типа данных usint или два параметра типа данных text для StrCmp"),
