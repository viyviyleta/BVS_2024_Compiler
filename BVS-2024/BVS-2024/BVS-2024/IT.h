#pragma once
#define ID_MAXSIZE 50 // максимальная длина идентификатора
#define TI_MAXSIZE 4096 // максимальное количество строк в таблице идентификаторов
#define TI_BYTE_DEFAULT 0 // Значение по умолчанию для byte - целочисленный тип данных в 4 байт
...
namespace IT {
	...
	struct Entry {
		...
		union {
			unsigned int vusint; // значение byte
